...
select * from (values
  ...
  ('PT. Hankook Tire', 'End user / Manufacturing', 'Cikarang', '작업 실적 등록 고객',
   'PT. Total Tire Bank 경유', '프로모션 50% 적용',
...
select * from (values
  ...
  (date '2026-07-01', 'PT. Total Tire Bank', 'PT. Hankook Tire',
  ...
  (date '2026-07-06', 'PT. Total Tire Bank', 'PT. Hankook Tire',
