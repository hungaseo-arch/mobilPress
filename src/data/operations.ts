    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['', 'Colt Diesel Box 구매 (Proban)', '157,761,640', '완료'],
            ['', '유압 프레스 제작·설치', '135,120,000', '완료'],
            ['', 'Ring & Spacer (프레스 포함)', 'Include', '프레스 포함'],
            ['', '스프링 수리', '800,000', '완료'],
            ['', '카로세리 개조 (도장·스티커·플라폰·벽면)', '27,750,000', '완료'],
            ['', '차량·설비 소계', '321,431,640', ''],
          ],
        },
      },
      {
      ...
      },
      {
        ...
        table: {
          headers: ['날짜', '항목', '금액 (Rp)', '비고'],
          rows: [
            ['2026-04-10', 'Congkel Ban (20", 24", 24")', '267,000', '벨그에서 타이어 탈착'],
            ['2026-04-16', 'Impact + 에어 호스', '2,850,000', '휠 볼트 탈거'],
            ['2026-04-17', 'Pertamina Dex', '200,000', '차량 연료'],
            ['2026-05-05', '소켓 비트 33/30/32/27/26/24/21/20/19/17mm', '700,000', '타이어 탈착'],
            ['2026-05-05', 'Kaca Mata Bening, Adaptor Socket 1"×3/4", Toolbox No.125, 목장갑, Extension Bar 8" 200mm, Deep Impact Socket 3/4" 6PT 34mm', '703,500', '타이어 탈착'],
            ['2026-05-13', 'Sikat Gagang Plastik, 오렌지 조끼, 흰 안전모, L핸들 소켓 3/4", 라쳇핸들 3/4" Auto Quick Release', '1,332,000', '작업자 장비'],
            ['2026-05-18', '보틀 잭 10톤, 해머 Palu Bodem 5kg', '1,015,000', '포크리프트 하중 리프팅'],
            ['2026-05-18', 'Wearpack (작업복)', '555,000', '작업 유니폼'],
            ['2026-06-05', 'Cargo Lashing 35mm×2000kg×6m', '525,000', '컴프레셔 결박'],
            ['2026-06-05', 'Ring Pas 12~24mm, Tang Buaya 10", Kunci Inggris 12", 고무망치 12oz, Kunci Palang 4', '486,000', '타이어 탈착'],
            ['2026-06-18', 'Pertamina Dex', '250,000', '차량 연료'],
            ['2026-06-18', 'E-Toll', '100,000', '통행료'],
            ['2026-06-25', 'Kabel Eterna 3×2.5mm, Solasi Nitto', '663,000', '컴프레셔 전선'],
            ['2026-06-29', 'Pertamina Dex', '501,000', '차량 연료'],
            ['2026-06-29', 'Standing Banner + SOP 포스터 인쇄', '555,500', 'SOP·배너'],
            ['2026-06-29', 'Pertalite (오토바이 연료)', '33,000', '오토바이 연료'],
            ['2026-06-29', 'Parkir (주차)', '2,000', '오토바이 주차'],
            ['2026-06-29', 'Tekiro Recoil Hose, 에어 주입 3기능', '175,000', '컴프레셔 공기 주입'],
            ['2026-06-29', 'Seal Tape, 드라이버, Cincin Claim', '40,000', '컴프레셔 공기 주입'],
            ['2026-06-30', 'Kunci Shock 1 Set 24pcs, WD40 333ml', '857,500', '휠 볼트 탈거'],
            ['2026-06-30', 'Helm (헬멧)', '50,000', 'PPE (방문용)'],
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['', 'Pembelian Mobil Colt Diesel Box (Proban)', '157,761,640', 'Selesai'],
            ['', 'Pembuatan & Pemasangan Mesin Press', '135,120,000', 'Selesai'],
            ['', 'Ring & Spacer (termasuk mesin press)', 'Include', 'Termasuk mesin press'],
            ['', 'Perbaikan Per Mobil', '800,000', 'Selesai'],
            ['', 'Perbaikan Karoseri (cat, stiker, plafon, dinding)', '27,750,000', 'Selesai'],
            ['', 'Subtotal Kendaraan & Mesin', '321,431,640', ''],
          ],
        },
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['', 'Safety Shoes (sudah ada)', '0', 'Sudah ada'],
      ...
      },
      {
        ...
        table: {
          headers: ['Tanggal', 'Item', 'Total (Rp)', 'Keterangan'],
          rows: [
            ['2026-04-10', 'Congkel Ban (20", 24", 24")', '267,000', 'Untuk buka pasang ban dari velg'],
            ['2026-04-16', 'Impact + Selang Angin', '2,850,000', 'Untuk buka baut ban'],
            ['2026-04-17', 'Pertamina Dex', '200,000', 'Untuk BBM Mobil'],
            ['2026-05-05', 'Mata Sock 33·30·32·27·26·24·21·20·19·17 mm', '700,000', 'Untuk bongkar pasang ban'],
            ['2026-05-05', 'Kaca Mata Bening, Adaptor Socket 1"×3/4", Tenka Toolbox No.125 (2 susun), Sarung Tangan Benang (1 lusin), Extention Bar Socket 8" 200mm, Deep Impact Socket 3/4" 6PT 34mm', '703,500', 'Untuk bongkar pasang ban'],
            ['2026-05-13', 'Sikat Gagang Plastik, Rompi Jaring Orange, Helm Proyek Putih, Gagang L Handle Socket 3/4", Rachet Handle 3/4" Auto Quick Release', '1,332,000', 'Untuk perlengkapan operator'],
            ['2026-05-18', 'Dongkrak 10 Ton, Palu Bodem 5 Kg', '1,015,000', 'Angkat beban forklift'],
            ['2026-05-18', 'Wearpack', '555,000', 'Seragam kerja'],
            ['2026-06-05', 'Cargo Lashing 35mm × 2000kg × 6mtr', '525,000', 'Untuk ikat kompresor'],
            ['2026-06-05', 'Ring Pas 12~24mm, Tang Buaya 10", Kunci Inggris 12", Palu Karet 12oz, Kunci Palang 4', '486,000', 'Untuk keperluan bongkar pasang ban'],
            ['2026-06-18', 'Pertamina Dex', '250,000', 'Untuk BBM Mobil'],
            ['2026-06-18', 'E-Toll', '100,000', 'Untuk transaksi tol'],
            ['2026-06-25', 'Kabel Eterna 3×2.5mm, Solasi Nitto', '663,000', 'Untuk listrik kompresor'],
            ['2026-06-29', 'Pertamina Dex', '501,000', 'Untuk BBM Mobil'],
            ['2026-06-29', 'Print Standing Banner + Poster SOP', '555,500', 'SOP · Standing banner'],
            ['2026-06-29', 'Pertalite', '33,000', 'BBM motor'],
            ['2026-06-29', 'Parkir', '2,000', 'Parkir motor'],
            ['2026-06-29', 'Tekiro Recoil Hose, Isian Angin 3 Fungsi', '175,000', 'Untuk keperluan isi angin dari kompresor'],
            ['2026-06-29', 'Seal Tape, Obeng, Cincin Claim', '40,000', 'Untuk keperluan isi angin dari kompresor'],
            ['2026-06-30', 'Kunci Shock 1 Set 24 Pcs, WD40 333ml', '857,500', 'Untuk buka baut velg'],
            ['2026-06-30', 'Helm', '50,000', 'Alat Pelindung Diri (untuk visit)'],
