    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['Eri', '영업팀 (General Manager)', '자카르타', '영업 총괄 관리 · 코디네이션', '-'],
    ...
    sections: [
      {
        ...
        table: {
          headers: ['구분', '날짜', '항목', '금액 (Rp)', '비고'],
          rows: [
            ['차량·설비', '2026-03-01', 'Colt Diesel Box 구매 (Proban)', '157,761,640', '완료'],
            ['차량·설비', '2026-03-01', '유압 프레스 제작·설치', '135,120,000', '완료'],
            ['차량·설비', '2026-03-01', 'Ring & Spacer (프레스 포함)', 'Include', '프레스 포함'],
            ['차량·설비', '2026-03-01', '스프링 수리', '800,000', '완료'],
            ['차량·설비', '2026-03-01', '카로세리 개조 (도장·스티커·플라폰·벽면)', '27,750,000', '완료'],
            ['차량·설비', '', '차량·설비 소계', '321,431,640', ''],
            ['공구·장비', '2026-04-01', '전동 컴프레셔 5 HP', '21,289,489', ''],
            ['공구·장비', '2026-04-01', 'Air Impact 1" + 에어 호스', '2,850,000', ''],
            ['공구·장비', '2026-04-01', '타이어 주걱/콩켈 (3pcs)', '267,000', ''],
            ['공구·장비', '2026-04-01', '공구 세트 + 안전경 + 장갑', '1,403,500', ''],
            ['공구·장비', '2026-04-01', '보틀 잭 10톤', '580,000', ''],
            ['공구·장비', '2026-04-01', '해머 5kg', '435,000', ''],
            ['공구·장비', '2026-04-01', '크로스렌치·고무망치·링파스·플라이어·영국렌치', '485,500', ''],
            ['공구·장비', '2026-04-01', '전선 Eterna 25m', '660,000', ''],
            ['공구·장비', '2026-04-01', '소켓 렌치 24pcs', '780,000', ''],
            ['공구·장비', '2026-04-01', 'WD40', '77,500', ''],
            ['공구·장비', '2026-04-01', '흰 헬멧 2개', '50,000', ''],
            ['공구·장비', '2026-04-01', '3상 플러그', '25,000', ''],
            ['공구·장비', '2026-04-01', 'APD (헬멧·조끼·안전용품)', '1,332,000', ''],
            ['공구·장비', '2026-04-01', '작업복 Wearpack 3벌', '555,000', ''],
            ['공구·장비', '2026-04-01', '반사 스티커 적색·황색', '1,260,000', ''],
            ['공구·장비', '2026-04-01', 'Safety Shoes (기보유)', '0', '기보유'],
            ['공구·장비', '2026-04-01', 'SIM A (2명) + SIM B1 Umum (3명)', '4,572,000', ''],
            ['공구·장비', '', '공구 소계', '36,622,489', ''],
            ['운영 예산', '2026-04-10', 'Congkel Ban (20", 24", 24")', '267,000', '벨그에서 타이어 탈착'],
            ['운영 예산', '2026-04-16', 'Impact + 에어 호스', '2,850,000', '휠 볼트 탈거'],
            ['운영 예산', '2026-04-17', 'Pertamina Dex', '200,000', '차량 연료'],
            ['운영 예산', '2026-05-05', '소켓 비트 33/30/32/27/26/24/21/20/19/17mm', '700,000', '타이어 탈착'],
            ['운영 예산', '2026-05-05', 'Kaca Mata Bening, Adaptor Socket 1"×3/4", Toolbox No.125, 목장갑, Extension Bar 8" 200mm, Deep Impact Socket 3/4" 6PT 34mm', '703,500', '타이어 탈착'],
            ['운영 예산', '2026-05-13', 'Sikat Gagang Plastik, 오렌지 조끼, 흰 안전모, L핸들 소켓 3/4", 라쳇핸들 3/4" Auto Quick Release', '1,332,000', '작업자 장비'],
            ['운영 예산', '2026-05-18', '보틀 잭 10톤, 해머 Palu Bodem 5kg', '1,015,000', '포크리프트 하중 리프팅'],
            ['운영 예산', '2026-05-18', 'Wearpack (작업복)', '555,000', '작업 유니폼'],
            ['운영 예산', '2026-06-05', 'Cargo Lashing 35mm×2000kg×6m', '525,000', '컴프레셔 결박'],
            ['운영 예산', '2026-06-05', 'Ring Pas 12~24mm, Tang Buaya 10", Kunci Inggris 12", 고무망치 12oz, Kunci Palang 4', '486,000', '타이어 탈착'],
            ['운영 예산', '2026-06-18', 'Pertamina Dex', '250,000', '차량 연료'],
            ['운영 예산', '2026-06-18', 'E-Toll', '100,000', '통행료'],
            ['운영 예산', '2026-06-25', 'Kabel Eterna 3×2.5mm, Solasi Nitto', '663,000', '컴프레셔 전선'],
            ['운영 예산', '2026-06-29', 'Pertamina Dex', '501,000', '차량 연료'],
            ['운영 예산', '2026-06-29', 'Standing Banner + SOP 포스터 인쇄', '555,500', 'SOP·배너'],
            ['운영 예산', '2026-06-29', 'Pertalite (오토바이 연료)', '33,000', '오토바이 연료'],
            ['운영 예산', '2026-06-29', 'Parkir (주차)', '2,000', '오토바이 주차'],
            ['운영 예산', '2026-06-29', 'Tekiro Recoil Hose, 에어 주입 3기능', '175,000', '컴프레셔 공기 주입'],
            ['운영 예산', '2026-06-29', 'Seal Tape, 드라이버, Cincin Claim', '40,000', '컴프레셔 공기 주입'],
            ['운영 예산', '2026-06-30', 'Kunci Shock 1 Set 24pcs, WD40 333ml', '857,500', '휠 볼트 탈거'],
            ['운영 예산', '2026-06-30', 'Helm (헬멧)', '50,000', 'PPE (방문용)'],
            ['운영 예산', '2026-06-30', 'Steker 3 Phase', '25,000', '전원 연결'],
            ['운영 예산', '2026-07-04', 'Stiker Reflektor', '1,260,000', '박스 차량 규정'],
            ['운영 예산', '', '운영 실적 합계', '13,145,500', ''],
          ],
        },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['공구·장비', '36,622,489', '—'],
            ['운영 예산', '17,130,474', '사용 13,145,500 | 잔액 3,984,974'],
          ],
        },
      },
    ],
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              '2026-05-13',
              'PT. HD Forklift Indonesia (Bu Rahayu·Bu Isma)',
              '포크리프트 유닛·타이어 렌탈/판매 · Hyundai(한국)·Movex(중국) 수입(PO 기반) · 전동 70%(신차)·디젤 30%(중고) · Lithium·Litachid 배터리',
              '기존 PT. DSL 견적 있음(가격 미제시) · RIM 20은 PT. Satria Piranti Perkasa에서 진행',
              'RIM 15: Rp 350K 요청(가격 과다 평가)',
              '고객: Bandung·Subang·Cikarang·Bekasi·Karawang·Cilegon · 프레스는 주문 위치에 따라 상이 · 중부자바는 경쟁 적어 진입 가능 · 프레스 수량은 필요시(불규칙)',
            ],
            [
              '2026-05-21',
              'CV. Berkat Abadi Liftindo (Bu Tanti)',
            ...
            [
              '2026-05-21',
              'PT. Vilicindo Anugerah Sejahtera (Bu Lili)',
            ...
            [
              '2026-05-26',
              'PT. Prime Forklift Service (Pak Panji)',
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['Eri', 'Tim Sales (General Manager)', 'Jakarta', 'Manajemen & koordinasi tim sales', '-'],
    ...
    sections: [
      {
        ...
        groupByFirstColumn: true,
        table: {
          headers: ['Kategori', 'Tanggal', 'Item', 'Total (Rp)', 'Keterangan'],
          rows: [
            ['Kendaraan & Mesin', '2026-03-01', 'Pembelian Mobil Colt Diesel Box (Proban)', '157,761,640', 'Selesai'],
            ['Kendaraan & Mesin', '2026-03-01', 'Pembuatan & Pemasangan Mesin Press', '135,120,000', 'Selesai'],
            ['Kendaraan & Mesin', '2026-03-01', 'Ring & Spacer (termasuk mesin press)', 'Include', 'Termasuk mesin press'],
            ['Kendaraan & Mesin', '2026-03-01', 'Perbaikan Per Mobil', '800,000', 'Selesai'],
            ['Kendaraan & Mesin', '2026-03-01', 'Perbaikan Karoseri (cat, stiker, plafon, dinding)', '27,750,000', 'Selesai'],
            ['Kendaraan & Mesin', '', 'Subtotal Kendaraan & Mesin', '321,431,640', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Kompresor Listrik 5 HP', '21,289,489', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Air Impact 1" + Selang Angin', '2,850,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Sendok / Congkel Ban (3 pcs)', '267,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Kunci 1 Set + Kacamata + Sarung Tangan', '1,403,500', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Dongkrak Botol 10 Ton', '580,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Palu Bodem 5 Kg', '435,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Kunci Palang, Palu Karet, Ring Pas, Tang, Kunci Inggris', '485,500', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Kabel Eterna 25m (baru)', '660,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Kunci Sok 24 pcs (baru)', '780,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'WD40 (baru)', '77,500', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Helm Putih 2 pcs (baru)', '50,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Steker Fort 3 Phase (baru)', '25,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'APD (Helmet, Rompi, Safety Tool)', '1,332,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Wearpack (3 pcs)', '555,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Stiker Reflektor Merah & Kuning (baru)', '1,260,000', ''],
            ['Tools & Perlengkapan', '2026-04-01', 'Safety Shoes (sudah ada)', '0', 'Sudah ada'],
            ['Tools & Perlengkapan', '2026-04-01', 'SIM A (2 org) + SIM B1 Umum (3 org)', '4,572,000', ''],
            ['Tools & Perlengkapan', '', 'Subtotal Tools', '36,622,489', ''],
            ['Anggaran Operasional', '2026-04-10', 'Congkel Ban (20", 24", 24")', '267,000', 'Untuk buka pasang ban dari velg'],
            ['Anggaran Operasional', '2026-04-16', 'Impact + Selang Angin', '2,850,000', 'Untuk buka baut ban'],
            ['Anggaran Operasional', '2026-04-17', 'Pertamina Dex', '200,000', 'Untuk BBM Mobil'],
            ['Anggaran Operasional', '2026-05-05', 'Mata Sock 33·30·32·27·26·24·21·20·19·17 mm', '700,000', 'Untuk bongkar pasang ban'],
            ['Anggaran Operasional', '2026-05-05', 'Kaca Mata Bening, Adaptor Socket 1"×3/4", Tenka Toolbox No.125 (2 susun), Sarung Tangan Benang (1 lusin), Extention Bar Socket 8" 200mm, Deep Impact Socket 3/4" 6PT 34mm', '703,500', 'Untuk bongkar pasang ban'],
            ['Anggaran Operasional', '2026-05-13', 'Sikat Gagang Plastik, Rompi Jaring Orange, Helm Proyek Putih, Gagang L Handle Socket 3/4", Rachet Handle 3/4" Auto Quick Release', '1,332,000', 'Untuk perlengkapan operator'],
            ['Anggaran Operasional', '2026-05-18', 'Dongkrak 10 Ton, Palu Bodem 5 Kg', '1,015,000', 'Angkat beban forklift'],
            ['Anggaran Operasional', '2026-05-18', 'Wearpack', '555,000', 'Seragam kerja'],
            ['Anggaran Operasional', '2026-06-05', 'Cargo Lashing 35mm × 2000kg × 6mtr', '525,000', 'Untuk ikat kompresor'],
            ['Anggaran Operasional', '2026-06-05', 'Ring Pas 12~24mm, Tang Buaya 10", Kunci Inggris 12", Palu Karet 12oz, Kunci Palang 4', '486,000', 'Untuk keperluan bongkar pasang ban'],
            ['Anggaran Operasional', '2026-06-18', 'Pertamina Dex', '250,000', 'Untuk BBM Mobil'],
            ['Anggaran Operasional', '2026-06-18', 'E-Toll', '100,000', 'Untuk transaksi tol'],
            ['Anggaran Operasional', '2026-06-25', 'Kabel Eterna 3×2.5mm, Solasi Nitto', '663,000', 'Untuk listrik kompresor'],
            ['Anggaran Operasional', '2026-06-29', 'Pertamina Dex', '501,000', 'Untuk BBM Mobil'],
            ['Anggaran Operasional', '2026-06-29', 'Print Standing Banner + Poster SOP', '555,500', 'SOP · Standing banner'],
            ['Anggaran Operasional', '2026-06-29', 'Pertalite', '33,000', 'BBM motor'],
            ['Anggaran Operasional', '2026-06-29', 'Parkir', '2,000', 'Parkir motor'],
            ['Anggaran Operasional', '2026-06-29', 'Tekiro Recoil Hose, Isian Angin 3 Fungsi', '175,000', 'Untuk keperluan isi angin dari kompresor'],
            ['Anggaran Operasional', '2026-06-29', 'Seal Tape, Obeng, Cincin Claim', '40,000', 'Untuk keperluan isi angin dari kompresor'],
            ['Anggaran Operasional', '2026-06-30', 'Kunci Shock 1 Set 24 Pcs, WD40 333ml', '857,500', 'Untuk buka baut velg'],
            ['Anggaran Operasional', '2026-06-30', 'Helm', '50,000', 'Alat Pelindung Diri (untuk visit)'],
            ['Anggaran Operasional', '2026-06-30', 'Steker 3 Phase', '25,000', 'Untuk sambungan listrik ke stop kontak'],
            ['Anggaran Operasional', '2026-07-04', 'Stiker Reflektor', '1,260,000', 'Untuk memenuhi standar kendaraan box'],
            ['Anggaran Operasional', '', 'Total Realisasi Ops', '13,145,500', ''],
          ],
        },
        ...
        table: {
          ...
          rows: [
            ...
            [
              '2026-05-13',
              'PT. HD Forklift Indonesia (Bu Rahayu & Bu Isma)',
              'Rental & jual unit forklift dan ban forklift · Merk Hyundai (Korea) & Movex (China) import, based on PO · Forklift elektrik 70% (unit baru), diesel 30% (unit lama) · Baterai Lithium & Litachid',
              'Sebelumnya ada penawaran dari PT. DSL (belum dikasih harga) · RIM 20 proses di PT. Satria Piranti Perkasa',
              'RIM 15: request Rp 350K (dinilai terlalu tinggi)',
              'Customer: Bandung, Subang, Cikarang, Bekasi, Karawang, Cilegon · Press ban tergantung lokasi order · Wilayah Jawa Tengah harga bisa masuk (pesaing sedikit) · QTY press sesuai kebutuhan (dadakan)',
            ],
            [
              '2026-05-21',
              'CV. Berkat Abadi Liftindo (Bu Tanti)',
