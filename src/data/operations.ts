    ...
    sections: [
      {
        ...
        note: '✔ 정식 운영 개시 완료 — 2026년 6월부터 서비스 가동 | ⚠️ STNK 명의변경 완료 후 KIR · IBM 순차 진행',
      },
    ],
  },
  {
        ...
        steps: [
          ...
          },
          {
            ...
            items: [
              ...
              '유압 레버 당겨 압력 적용 (Split 벨그: 콩켈로 벨그 분리 / One-piece 벨그: 링을 콩켈로 탈거)',
              '타이어 완전 분리까지 압력 유지',
              '신품 타이어 역순 조립',
            ],
          },
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Ranggi', 'Tim Sales', 'Jakarta', 'Kunjungan customer · Koordinasi lapangan', 'SIM A'],
            ['Wisnu', 'Tim Sales', 'Jakarta', 'Dokumentasi · Support sales', '-'],
            ['Firman', 'Tim Operasional (General Manager)', 'Karawang', 'Operasional Mobil Press · Maintenance kendaraan & mesin · Report kegiatan', 'SIM B1 Umum'],
            ['Harun', 'Tim Operasional', 'Karawang', 'Operasional · Maintenance · Report kegiatan', 'SIM B1 Umum'],
            ['Arun', 'Tim Operasional', 'Karawang', 'Operasional · Maintenance · Report kegiatan', 'SIM B1 Umum'],
          ],
        },
