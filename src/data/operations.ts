    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['차량·설비', '', 'Colt Diesel Box 구매 (Proban)', '157,761,640', '완료'],
            ['차량·설비', '', '유압 프레스 제작·설치', '135,120,000', '완료'],
            ['차량·설비', '', 'Ring & Spacer (프레스 포함)', 'Include', '프레스 포함'],
            ['차량·설비', '', '스프링 수리', '800,000', '완료'],
            ['차량·설비', '', '카로세리 개조 (도장·스티커·플라폰·벽면)', '27,750,000', '완료'],
            ['차량·설비', '', '차량·설비 소계', '321,431,640', ''],
            ['공구·장비', '', '전동 컴프레셔 5 HP', '21,289,489', ''],
            ['공구·장비', '', 'Air Impact 1" + 에어 호스', '2,850,000', ''],
            ['공구·장비', '', '타이어 주걱/콩켈 (3pcs)', '267,000', ''],
            ['공구·장비', '', '공구 세트 + 안전경 + 장갑', '1,403,500', ''],
            ['공구·장비', '', '보틀 잭 10톤', '580,000', ''],
            ['공구·장비', '', '해머 5kg', '435,000', ''],
            ['공구·장비', '', '크로스렌치·고무망치·링파스·플라이어·영국렌치', '485,500', ''],
            ['공구·장비', '', '전선 Eterna 25m', '660,000', ''],
            ['공구·장비', '', '소켓 렌치 24pcs', '780,000', ''],
            ['공구·장비', '', 'WD40', '77,500', ''],
            ['공구·장비', '', '흰 헬멧 2개', '50,000', ''],
            ['공구·장비', '', '3상 플러그', '25,000', ''],
            ['공구·장비', '', 'APD (헬멧·조끼·안전용품)', '1,332,000', ''],
            ['공구·장비', '', '작업복 Wearpack 3벌', '555,000', ''],
            ['공구·장비', '', '반사 스티커 적색·황색', '1,260,000', ''],
            ['공구·장비', '', 'Safety Shoes (기보유)', '0', '기보유'],
            ['공구·장비', '', 'SIM A (2명) + SIM B1 Umum (3명)', '4,572,000', ''],
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ['Kendaraan & Mesin', '', 'Pembelian Mobil Colt Diesel Box (Proban)', '157,761,640', 'Selesai'],
            ['Kendaraan & Mesin', '', 'Pembuatan & Pemasangan Mesin Press', '135,120,000', 'Selesai'],
            ['Kendaraan & Mesin', '', 'Ring & Spacer (termasuk mesin press)', 'Include', 'Termasuk mesin press'],
            ['Kendaraan & Mesin', '', 'Perbaikan Per Mobil', '800,000', 'Selesai'],
            ['Kendaraan & Mesin', '', 'Perbaikan Karoseri (cat, stiker, plafon, dinding)', '27,750,000', 'Selesai'],
            ['Kendaraan & Mesin', '', 'Subtotal Kendaraan & Mesin', '321,431,640', ''],
            ['Tools & Perlengkapan', '', 'Kompresor Listrik 5 HP', '21,289,489', ''],
            ['Tools & Perlengkapan', '', 'Air Impact 1" + Selang Angin', '2,850,000', ''],
            ['Tools & Perlengkapan', '', 'Sendok / Congkel Ban (3 pcs)', '267,000', ''],
            ['Tools & Perlengkapan', '', 'Kunci 1 Set + Kacamata + Sarung Tangan', '1,403,500', ''],
            ['Tools & Perlengkapan', '', 'Dongkrak Botol 10 Ton', '580,000', ''],
            ['Tools & Perlengkapan', '', 'Palu Bodem 5 Kg', '435,000', ''],
            ['Tools & Perlengkapan', '', 'Kunci Palang, Palu Karet, Ring Pas, Tang, Kunci Inggris', '485,500', ''],
            ['Tools & Perlengkapan', '', 'Kabel Eterna 25m (baru)', '660,000', ''],
            ['Tools & Perlengkapan', '', 'Kunci Sok 24 pcs (baru)', '780,000', ''],
            ['Tools & Perlengkapan', '', 'WD40 (baru)', '77,500', ''],
            ['Tools & Perlengkapan', '', 'Helm Putih 2 pcs (baru)', '50,000', ''],
            ['Tools & Perlengkapan', '', 'Steker Fort 3 Phase (baru)', '25,000', ''],
            ['Tools & Perlengkapan', '', 'APD (Helmet, Rompi, Safety Tool)', '1,332,000', ''],
            ['Tools & Perlengkapan', '', 'Wearpack (3 pcs)', '555,000', ''],
            ['Tools & Perlengkapan', '', 'Stiker Reflektor Merah & Kuning (baru)', '1,260,000', ''],
            ['Tools & Perlengkapan', '', 'Safety Shoes (sudah ada)', '0', 'Sudah ada'],
            ['Tools & Perlengkapan', '', 'SIM A (2 org) + SIM B1 Umum (3 org)', '4,572,000', ''],
