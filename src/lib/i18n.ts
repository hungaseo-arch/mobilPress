...
const messages: Record<string, { id: string; ko: string }> = {
  ...
  'th.userCustomer': { id: 'Customer Pengguna', ko: '이용 고객' },
  'th.requestCustomer': { id: 'Customer Pemohon', ko: '요청 고객' },
  ...
  'th.rank': { id: 'No', ko: '순위' },
  'th.installCustomer': { id: 'Customer Pemasangan', ko: '장착 고객' },
  ...
  'revenue.customersUnit': { id: 'customer', ko: '개 고객사' },
  ...
  'form.distributor': { id: 'Distributor', ko: '딜러/총판' },
  'form.customerName': { id: 'Customer *', ko: '고객사 *' },
